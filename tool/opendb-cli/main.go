...
import (
	...
	"github.com/Berlin-opendb-hack/opendb-mock/tool/cli"
...
func main() {
	...
	app := &cobra.Command{
		Use:   "opendb-cli",
		Short: `CLI client for the opendb service`,
	}
	...
	app.PersistentFlags().StringVarP(&c.Host, "host", "H", "localhost:8880", "API hostname")
