...
func GetTransactionsTransactionsOK(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.TransactionsController) (http.ResponseWriter, app.OpendbHackTransactionCollection) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
