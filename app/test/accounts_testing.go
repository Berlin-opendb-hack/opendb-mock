...
func GetCashAccountsAccountsOK(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.AccountsController) (http.ResponseWriter, app.OpendbHackCashaccountCollection) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
